                ...
                <div class="grid grid-cols-1 gap-8 md:grid-cols-3">
                    ...
                    <div>
                        ...
                        <ul class="mt-4 space-y-4">
                            <li>
                                <a href="#products" class="text-base text-gray-700 transition-colors hover:text-black">
                                    Products
                                </a>
                            </li>
                            <li>
                                <a href="#about" class="text-base text-gray-700 transition-colors hover:text-black">
                                    About
                                </a>
                            </li>
                            <li>
                                <a href="#contact" class="text-base text-gray-700 transition-colors hover:text-black">
                                    Contact
                                </a>
                            </li>
                        </ul>
                    ...
                    <div>
                        ...
                        <div class="flex mt-4 space-x-6">
                            <a href="#" class="text-gray-700 transition-colors hover:text-black">
