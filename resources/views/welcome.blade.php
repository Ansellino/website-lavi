                ...
                <div class="grid grid-cols-1 gap-8 md:grid-cols-3">
                    ...
                    <div>
                        ...
                        <ul class="mt-4 space-y-4">
                            <li>
                                <a href="{{ route('login') }}" class="text-base text-gray-400 transition-colors hover:text-black">
                                    Products
                                </a>
                            </li>
                            <li>
                    ...
                    <div>
                        ...
                        <div class="flex mt-4 space-x-6">
                            <a href="https://www.instagram.com/lavioxel" class="text-gray-400 transition-colors hover:text-black">
